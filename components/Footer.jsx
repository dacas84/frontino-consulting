  ...
  <footer className="border-t border-white/10 py-12">
    <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
      <div className="flex items-center gap-3">
        ...
        <p className="text-sm font-bold tracking-tight">Frontino Technologies</p>
      </div>
      <div className="flex gap-8 text-sm text-slate-500"></div>
      <p className="text-xs text-slate-600">© 2026 Frontino Technologies. All rights reserved.</p>
    </div>
  </footer>
);
